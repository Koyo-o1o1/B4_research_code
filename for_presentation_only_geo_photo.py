...
def save_reconstructed_image_only(reconstructed_image_raw, save_path="final_reconstruction.png"):
    plt.figure(figsize=(6, 6))
    plt.imshow(reconstructed_image_raw, cmap='gray')
    plt.axis("off")  # 軸を非表示
...
if __name__ == '__main__':
    ...
    # 再構成画像のみ保存
    save_reconstructed_image_only(reconstructed_image_raw, save_path="output_images/final_reconstruction_onlyonly.png")
